...
public class MeanFilter extends RecursiveTask<double[]>{
	 ...
	 * @param dataSet
	 */
	public MeanFilter(double[] dataSet) throws NullPointerException{
	 ...
	 */
	public MeanFilter(double[] dataSet2, int low, int hi) {
